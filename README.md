...
| <a name="input_encryption"></a> [encryption](#input\_encryption) | Boolean to determine if encryption is enabled on the state bucket. | `bool` | `true` | no |
| <a name="input_versioning"></a> [versioning](#input\_versioning) | Boolean to determine if versioning is enabled on the state bucket. | `bool` | `true` | no |
